...
var msJS = function(){
    ...
    this.ext_ms = function(tab_id, tab_title, param){
        ...
        var server_mode = new Ext.grid.ColumnModel([
            ...
            {header : 'server_status1', id : 'server_status1', dataIndex : 'server_status1', sortable : true, renderer : server_status, hidden : true},
            {header : 'server_status2', id : 'server_status2', dataIndex : 'server_status2', sortable : true, renderer : server_status, hidden : true},
