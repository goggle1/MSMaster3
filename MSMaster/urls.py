...
urlpatterns = patterns('',
    ...
    url(r'^room_add_hot_tasks/([^/]+)/$',       'room.views.room_add_hot_tasks'),
    url(r'^room_delete_cold_tasks/([^/]+)/$',   'room.views.room_delete_cold_tasks'),
    url(r'^rooms_auto_distribute_tasks/([^/]+)/$',    'room.views.rooms_auto_distribute_tasks'),
    url(r'^rooms_auto_delete_tasks/([^/]+)/$',        'room.views.rooms_auto_delete_tasks'),
    ...
    url(r'^virtual_room_simulate_add/([^/]+)/$',    'virtual_room.views.virtual_room_simulate_add'),
    url(r'^virtual_room_simulate_delete/([^/]+)/$', 'virtual_room.views.virtual_room_simulate_delete'),
    url(r'^virtual_room_percent_topN/([^/]+)/$',    'virtual_room.views.virtual_room_percent_topN'),
    url(r'^get_max_virtual_room_id/([^/]+)/$',  'virtual_room.views.get_max_virtual_room_id'),
